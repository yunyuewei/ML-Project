...
\begin{figure}[H]
  \begin{minipage}[b]{\linewidth}
    ...
    \subcaption{The original image img\_7224}
  \end{minipage}
  %
  \begin{minipage}[b]{\linewidth}
    \centering
    \includegraphics[height=4cm]{figs/ReLU_2.jpg}
    \subcaption{The feature map of the first activation layer.}
    \vspace{2mm}
  \end{minipage}
  %
  \begin{minipage}{\linewidth}
    ...
    \subcaption{The original image img\_12875}
  \end{minipage}
  %
  \begin{minipage}[b]{\linewidth}
    \centering
